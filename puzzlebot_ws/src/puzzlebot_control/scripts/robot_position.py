...
#Codigo para llegar a un punto por medio de control
import rospy 
...
class PositionClass(): 
    def __init__(self): 
        ...
        while not rospy.is_shutdown():
            ...
            if (self.e_theta < 0.06) and (self.e_theta > -0.06) and (self.e_dist < 0.009) and (self.e_dist > -0.009):
                self.velocity.angular.z = 0
                self.velocity.linear.x = 0 
                print("done")
